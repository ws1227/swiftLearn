...
-(UIImageView *)imageView:(UIImageView *)imageView Url:(NSURL *)url
{
    //具体逻辑在基类 重写了
    return nil;
}
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!self.onlyDisplayText && [imagePath isKindOfClass:[NSString class]]) {
        if ([imagePath hasPrefix:@"http"]) {
            cell.imageView =[self imageView:cell.imageView Url:[NSURL URLWithString:imagePath]];
//            cell.imageView.image=[UIImage imageNamed:@"tab_5th_h"];
        } else {
